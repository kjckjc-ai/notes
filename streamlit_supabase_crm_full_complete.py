...
# Supabase CRM - Final Complete Version with All Fixes and Features
...
with tabs[2]:
    ...
    for note in notes:
        ...
        st.download_button("Download Note", note["body"], file_name=f"{note['title']}.txt", key=f"download_{note['id']}")
        st.markdown("---")
